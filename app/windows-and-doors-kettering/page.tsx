...
export const metadata: Metadata = {
  title: "Windows and Doors Kettering | Newleaf Windows & Doors",
  description:
    "Windows and doors in Kettering from Newleaf Windows & Doors. Visit our local showroom near Kettering for replacement windows, doors and free quotes.",
  alternates: {
    canonical: "/windows-and-doors-kettering",
  },
};

export default function WindowsAndDoorsKetteringPage() {
  return (
          ...
          <div className="grid min-h-[68vh] items-center gap-10 py-12 md:grid-cols-[1.05fr_0.95fr]">
            <div>
              <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-yellow-400">
                Local showroom near Kettering
              </p>
              <h1 className="font-serif text-5xl font-medium leading-tight md:text-7xl">
                Windows and doors in Kettering.
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-relaxed text-neutral-200 md:text-xl">
                Newleaf supplies and installs quality windows and doors for
                homes in Kettering, Desborough, Rothwell, Burton Latimer and
                nearby villages.
              </p>
